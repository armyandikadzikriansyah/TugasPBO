...
public class PesanPbo {
    ...
    private static ArrayList<Pesan> bayar( ArrayList<Pesan> p ){
        Scanner sc = new Scanner(System.in);
        Integer total_pembayaran, harga;
        boolean ok;
        int total_harga = 0;
        ...
        do {
            ...
            ok = Totalcheck(total_pembayaran, total_harga);
            System.out.println("--------------------------------------------------------------------");
    ...
    public static boolean QuantitiCheck(int n) {
        boolean ok = false;
    ...
    public static boolean Totalcheck(int n, int x) {
        boolean ok = false;
